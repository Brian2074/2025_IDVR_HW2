...
public class AudioRecorder : MonoBehaviour
{
    ...
    [SerializeField] private AudioPlayer lipsyncAudioPlayer;
    ...
    public void StartRecording()
    {
        ...
        {
            audioPlayer.CancelAudioPlayback();
            lipsyncAudioPlayer.CancelAudioPlayback();
        }
        audioPlayer.ResetCancelPending();
        lipsyncAudioPlayer.ResetCancelPending();
        microphoneDevice = Microphone.devices[0];
    ...
    {
        Debug.Log("[AudioRecorder] VAD Started - Listening...");
        if (interruptResponseOnNewRecording && !isVADRecording) 
        {
            audioPlayer.CancelAudioPlayback();
            lipsyncAudioPlayer.CancelAudioPlayback();
        }
